...
(function () {
        ...
        startConnection(url, configureConnection)
            .then(function (connection) {
                ...
                connection.invoke('register').then(function () {
                    console.debug('Registered to the SignalR server!'); //TODO: Remove log
                });
            })
    ...
    function startConnection(url, configureConnection) {
        ...
        return function start(transport) {
            console.debug('Starting connection using ' + signalR.TransportType[transport] + ' transport');
            ...
            return connection.start()
                ...
                .catch(function (error) {
                    console.debug('Cannot start the connection using ' + signalR.TransportType[transport] + ' transport. ' + error.message);
